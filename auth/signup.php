...
//CHANGE initialized both variables so they would not give undefined variable errors 
$errorMessage = null;
$successMessage = null;
if (count($_POST) > 0) {
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST">
						<!-- CHANGE added logic to check if value is equal to null since both needed to be initialized -->
