...
<html lang="en">
    <head>
        ...
        <title>Admin View of Shop page </title>
        <!-- Favicon-->
							...
							<div class="card h-100">
								...
								<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
									<div class="text-center">
										...
										<a class="btn btn-outline-dark mt-auto" href="admindetail.php?name=<?php echo urlencode($product['name']); ?>">Details</a>
									</div>
									<br>
									<div class="text-center">
										<!-- Link to edit page with product index -->
										<a class="btn btn-outline-warning mt-auto" href="adminedit.php?index=<?php echo $index; ?>">Edit</a>
									</div>
									<br>
									<div class="text-center">
										<!-- Link to delete page with product index -->
										<a class="btn btn-outline-danger mt-auto" href="admindelete.php?index=<?php echo $index; ?>" onclick="return confirm('Are you sure you want to delete this product?');">Delete</a>
									</div>
								</div>
							</div>
						</div>
